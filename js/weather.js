...
function getDataWeather() {
    $.ajax({
        url: "http://api.wunderground.com/api/33f5b88609699d6b/conditions/q/IL/Chicago.json",
        type: "GET",
        dataType: "text",
...
function getFutureWeather() {
    $.ajax({
        url: "http://api.wunderground.com/api/33f5b88609699d6b/forecast/q/IL/Chicago.json",
        type: "GET",
        dataType: "text",
        success: function (data) {
            var json = $.parseJSON(data);
